...
module.exports = (client) => {
    ...
    client.errNormal = async function ({
        ...
        embed.setTitle(`<a:wrong:1113161611016937563>v・Error!`)
    ...
    client.errUsage = async function ({
        ...
        embed.setTitle(`<a:wrong:1113161611016937563>・Error!`)
    ...
    client.succNormal = async function ({
        ...
        embed.setTitle(`<a:verified:1113159591119818782>・Success!`)
   ...
   client.poll = async function ({
        ...
        if (color) embed.setColor(color);
        if (functiondata && functiondata.Color && !color) embed.setColor(functiondata.Color)
       const embedMessage = await interaction.channel.send({ embeds: [embed], content: content, components: components, type: type });

  // Add tick and cross reactions to the embed message
  await embedMessage.react('✅'); // Tick emoji
  await embedMessage.react('❌'); // Cross emoji
}
